...
For detailed setup instructions, please see the [Setup Guide](./docs/admin_setup.md) which provides step-by-step instructions for creating and configuring a Microsoft Teams application in Azure.
