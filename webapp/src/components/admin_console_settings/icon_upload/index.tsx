...
const IconUpload: React.FC<Props> = (props) => {
    ...
    const iconPath = `/plugins/com.mattermost.ms-embedded/icons/${iconType}`;
    ...
    const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const response = await fetch('/plugins/com.mattermost.ms-embedded/icons/upload',
                Client4.getOptions({
                    method: 'POST',
                    body: formData,
                }),
    ...
    const handleRemove = async () => {
        ...
        try {
            const response = await fetch(`/plugins/com.mattermost.ms-embedded/icons/${iconType}`,
                Client4.getOptions({
                    method: 'DELETE',
                }),
            );
